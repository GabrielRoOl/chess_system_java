...
public class UI {
	...
	public static final String ANSI_BLACK_BACKGOUND = "\u001B[40m";
	public static final String ANSI_RED_BACKGOUND = "\u001B[41m";
	public static final String ANSI_GREEN_BACKGOUND = "\u001B[42m";
	...
	public static void printMatch(ChessMatch chessMatch) {
		printBoard(chessMatch.getPiecer());
		System.out.println();
	...
	private static void printPiece(ChessPiece piece, boolean background) {
		if (background) {
			System.out.print(ANSI_BLUE_BACKGOUND);
		}
		if (piece == null) {
